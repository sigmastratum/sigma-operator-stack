...
_INSTRUCTION_BLOCK = (
    ...
    + "The MCP launcher binding authenticates the managed Python executable used by this project-local server. "
    + "The separate maintenance launcher binding authenticates the public archive and Install-SOS.command; their "
    + "digests identify different files and must never be compared. For maintenance, rediscover the canonical "
    + "release pointer, download and verify a fresh exact archive, compare its maintenance binding with the "
    + "lifecycle receipt, then invoke the newly extracted platform launcher. Do not rely on an old temporary extraction. "
